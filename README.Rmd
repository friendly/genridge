...
A standard, univariate, trace plot simply plots the estimated coefficients for each predicator
...
show the accomaning decrease in variance. For that, we need to consider the variances and
